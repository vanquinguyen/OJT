...
import jappan.validate.RoleValidator;
...
public class RoleController {
	...
	public String showRoleList(Model model, HttpSession session, @ModelAttribute("modelList") Role role, @PathVariable("page") int page) {
