		...
		<div class="">
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="container">
					<form:form modelAttribute="modelList" servletRelativeAction="/role/list/1" method="POST"></form:form>
					</div>
				</div>
				<div class="table-responsive">
					<table class="table table-striped jambo_table bulk_action">
						...
						<tbody>
							<c:forEach items="${role}" var="roles" varStatus="loop">
								...
								<td class=" ">${roles.roleName}</td>
								<td class=" ">${roles.description}</td>
								<td class="text-center"><a
									href="<c:url value="/role/view/${roles.id}"/>"
									class="btn btn-round btn-secondary">View</a></td>
								<td class="text-center"><a
									href="<c:url value="/role/edit/${roles.id}"/>"
									class="btn btn-round btn-primary">Edit</a></td>
								<td class="text-center"><a href="javascript:void(0);"
									onclick="confirmDelete(${roles.id});"
