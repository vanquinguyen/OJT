					...
					<div class="container">
						<form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/user/list/1" method="POST">
							<div class="item form-group">
								<label class="col-form-label col-md-3 col-sm-3 label-align" for="fullName"> Full Name </label>
						...
						<tbody>
							<c:forEach items="${users}" var="user" varStatus="loop">
								...
								<td class="text-center"><a
									href="<c:url value="/user/view/${user.id}"/>"class="btn btn-round btn-secondary">View</a></td>
								<td class="text-center"><a
									href="<c:url value="/user/edit/${user.id}"/>" class="btn btn-round btn-primary">Edit</a></td>
